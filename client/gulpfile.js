...
gulp.task('move-index', function () {
  return gulp.src(['dist/index.build.html'])
    ...
    .pipe(replace('"index.build.js"', '"/static/index.build.js"'))
    .pipe(replace('"images/', '"/static/images/'))
    .pipe(gulp.dest('../app/static'))
    .pipe($.size({title: 'move'}))
});

gulp.task('move-others', function() {
  var root = gulp.src([
    'dist/index.build.js',
    'dist/favicon.ico',
  ], {
  ...
  var images = gulp.src('dist/images/**/*')
    .pipe(gulp.dest('../app/static/images'));

  return merge(root, images).pipe($.size({title: 'move-others'}));
});
